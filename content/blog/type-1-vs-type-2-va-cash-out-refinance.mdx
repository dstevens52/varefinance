...
**Scenario 2: Rate reduction on an existing VA loan without IRRRL eligibility**

Occasionally, a veteran wants to lower their rate on an existing VA loan but does not meet the IRRRL's seasoning requirements (210 days and 6 payments). Or perhaps they want to add a borrower to the mortgage — something the IRRRL does not allow. In these cases, a Type I Cash-Out Refinance can accomplish the rate reduction through the full underwriting process, without actually taking cash out.
...
- Borrow up to 100% of the home's appraised value (subject to lender LTV limits)
