...
The [VA IRRRL](/va-irrrl) is a streamline refinance of an existing VA loan. The VA already verified your eligibility, your income, and your creditworthiness when you got the original loan. You're not taking on new debt — you're restructuring existing debt at a lower rate. The VA's position is that re-underwriting you from scratch for this purpose is unnecessary. So it doesn't require it.
...
The VA's own requirements for an IRRRL are minimal. Here is what the VA mandates:
