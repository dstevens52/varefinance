...
2. **Refinance both loans together.** A VA Cash-Out Refinance can pay off both your existing VA loan and the second mortgage simultaneously, combining everything into a single new first-lien VA loan. This involves full underwriting and higher closing costs than an IRRRL, but it resolves the lien position issue cleanly.
