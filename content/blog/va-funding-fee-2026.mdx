---
title: "VA Funding Fee Chart 2026: Rates by Loan Type"
description: "The complete VA funding fee chart for 2026 — rates by loan type and use scenario for purchase, IRRRL, and cash-out loans, plus down-payment tiers, exemption rules, and dollar examples."
date: "2026-03-12"
...
For 2026, VA funding fees range from 0.5% for an IRRRL to 3.3% for a subsequent-use purchase or cash-out loan with no down payment. First-time purchase borrowers pay 2.15% with no down payment, dropping to 1.25% with 10% or more down. Veterans receiving VA disability compensation are fully exempt.

<table>
  <caption>VA Funding Fee Chart — 2026 Rates by Loan Type and Use</caption>
  <thead>
    <tr>
      <th scope="col">Loan Type</th>
      <th scope="col">Down Payment</th>
      <th scope="col">First Use</th>
      <th scope="col">Subsequent Use</th>
    </tr>
  </thead>
  <tbody>
    <tr>
    ...
    <tr>
      <th scope="row">IRRRL (Streamline Refinance)</th>
      <td>N/A</td>
      <td>0.50%</td>
      <td>0.50%</td>
    </tr>
    <tr>
      <th scope="row">Cash-Out Refinance</th>
      <td>N/A</td>
      <td>2.15%</td>
      <td>3.30%</td>
    </tr>
...
Rates apply to all eligible veterans, active-duty service members, and National Guard and Reserve members. The detailed breakdowns by loan type, dollar-amount examples, and exemption rules follow below.
...
Not sure of your combined rating? Use the [VA Disability Combined Rating Calculator](https://milpaytools.com/calculators/va-disability) to calculate it using the VA's bilateral factor math.
