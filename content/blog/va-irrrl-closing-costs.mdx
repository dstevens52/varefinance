...
The largest IRRRL-specific cost is the **VA funding fee**, which is set by law at **0.5%** of the loan amount for IRRRL transactions. This is significantly lower than the funding fee on VA purchase loans or cash-out refinances, which range from 2.15% to 3.3%. See the <a href="https://www.va.gov/housing-assistance/home-loans/funding-fee-and-closing-costs/" target="_blank" rel="noopener noreferrer">VA's official funding fee and closing costs page</a> for the current fee schedule.
...
**Second mortgage subordination.** Veterans with a HELOC or home equity loan behind their VA loan must obtain a [subordination agreement from the second lien holder](/blog/va-irrrl-second-mortgage-subordination) before the IRRRL can close. Most second lenders charge a fee of $100–$300 for this — a separate cost not reflected in your Loan Estimate.

## Bottom Line

VA IRRRL closing costs are genuinely lower than other refinance products — especially for veterans who are exempt from the funding fee. For most borrowers, the total cost ranges from $1,500 to $5,000 on a typical loan balance, all of which can be rolled in if needed. The 36-month recoupment rule provides a built-in sanity check to ensure the refinance actually benefits you. To put these numbers in context, [see the latest refinance trends](/data/va-refinance-snapshot) — including quarterly refinance volume and what veterans with similar loan balances are saving right now.

Our [VA Refinance Calculator](/calculator) can help you estimate your break-even timeline based on your specific loan balance, current rate, and expected new rate — before you contact a single lender. If you're still deciding whether a refinance makes sense at all, see our guide on [when to refinance a VA loan](/blog/when-to-refinance-va-loan).
