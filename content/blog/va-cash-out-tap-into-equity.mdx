...
The VA allows eligible borrowers to access up to **100% of their home's appraised value** (100% loan-to-value, or LTV). This is more generous than conventional cash-out options, which typically cap at 80% LTV.

**Example:**

- Home value: $450,000
- Current mortgage balance: $280,000
- Available equity at 90% LTV: $405,000 – $280,000 = **$125,000 in cash**
- Available equity at 100% LTV: $450,000 – $280,000 = **$170,000 in cash**

Note that individual lenders may impose their own maximum LTV limits (commonly 90%), even if the VA technically allows 100%. Shop multiple lenders to find the most favorable terms.
...
| Can receive cash | No | Yes, up to 100% LTV |
...
Whether it is the right move depends on your rate environment, your financial goals, and how long you plan to stay in the home. Use our [VA Refinance Calculator](/calculator) to run your own numbers and see your estimated savings and break-even point before speaking with any lender.
